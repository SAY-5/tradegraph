...
| `holdings/*.json` | Synthetic 13F-HR style information tables, one file per fund family, two quarters per fund | 820 filings, 24,336 positions |

Total legal entities: 6,100 (the 58 asset managers are both issuers and 13F filers).
Every fund reports for 2024-03-31 and 2024-06-30; between the two quarters a few
lines are opened, one is sold and every third carried line moves. Holdings
quantities, values, CUSIPs, accession numbers and subsidiary names are synthetic
and derived from a fixed seed.
