...
| `holdings/*.json` | Synthetic 13F-HR style information tables, one file per fund family | 12,941 positions |

Total legal entities: 6,158. Holdings quantities, values, CUSIPs, accession
